...
@php
$btnType = [
'secondary' => 'w-full justify-center inline-flex items-center px-4 py-2 bg-gray-200 border
...
'danger' => 'w-full justify-center inline-flex items-center px-4 py-2 bg-red-500 border
...
'info' => 'w-full justify-center inline-flex items-center px-4 py-2 bg-blue-300 border
...
'warning' => 'w-full justify-center inline-flex items-center px-4 py-2 bg-yellow-500 border
...
'success' => 'w-full justify-center inline-flex items-center px-4 py-2 bg-green-500 border
...
'primary' => 'w-full justify-center inline-flex items-center px-4 py-2 bg-blue-800 dark:bg-blue-600 border

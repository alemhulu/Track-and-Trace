@props(['search' => false])
<div class="flex justify-between items-center flex-wrap py-3 border-b border-gray-200 sm:px-5">
    <header class="flex flex-shrink-0">
        <div class="mx-auto py-1">
            <p class="font-semibold text-xl text-lime-800">
                {{ $slot }}
            </p>
        </div>
    </header>
    ...
    <div class="{{ $search ? '' : 'hidden' }}  w-full sm:max-w-xs">
        ...
        <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 pl-3 flex items-center">
                ...
                <svg class="h-6 w-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"

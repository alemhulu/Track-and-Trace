<div>
    <x-form.card function="addBook" title="Add New Route">
                    ...
                    <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <x-jet-input type="text" name="name" id="name" class="max-w-md" />
                            </div>
                        </div>
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-3">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                ...
                                <x-jet-input-error for="description" alert="Wearhouse Description" />
                            </div>
                        </div>

    ...
    <div class="mb-6">
        <x-page.nav col='4'>
            ...
            <x-page.nav-link class="bg-yellow-600" title="Add Organization" tabLink="AddOrganization"
                icon="fi fi-rr-plus" />
            <x-page.nav-link class="bg-yellow-700" title="Add Warehouse" tabLink="AddWearhouse" icon="fi fi-rr-plus" />
        ...
        <div id="AddWearhouse" class="mt-6  tab mb-6" style="display:none; ">
